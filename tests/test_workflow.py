...
class WorkflowTestRunner:
    ...
    def test_dom_and_cache_integrity(self):
        ...
        # 5. Cache Invalidation Version Bumps (v=3.9)
        if self.mode == "LIVE_HTTP":
            self.assert_test("styles.css has fresh cache version (?v=3.8 or ?v=3.9)", 'styles.css?v=3.8' in html or 'styles.css?v=3.9' in html)
            self.assert_test("app.js has fresh cache version (?v=3.8 or ?v=3.9)", 'app.js?v=3.8' in html or 'app.js?v=3.9' in html)
        else:
            self.assert_test("styles.css has cache version ?v=3.9", 'styles.css?v=3.9' in html)
            self.assert_test("app.js has cache version ?v=3.9", 'app.js?v=3.9' in html)
        ...
        self.assert_test(
            "Service Worker contains CACHE_NAME travel-scout-v3.8/v3.9",
            "travel-scout-v3.9" in sw_res.text or "travel-scout-v3.8" in sw_res.text
        )
