...
class WorkflowTestRunner:
    ...
    def test_dom_and_cache_integrity(self):
        ...
        # 4. Cache Invalidation Version Bumps (v=3.8)
        self.assert_test("styles.css has cache version ?v=3.8", 'styles.css?v=3.8' in html)
        self.assert_test("app.js has cache version ?v=3.8", 'app.js?v=3.8' in html)

        # 5. Service Worker headers
        ...
        self.assert_test("Service Worker contains CACHE_NAME travel-scout-v3.8", "travel-scout-v3.8" in sw_res.text)
