...
class WorkflowTestRunner:
    ...
    def test_dom_and_cache_integrity(self):
        ...
        if self.mode == "LIVE_HTTP":
            self.assert_test("styles.css has fresh cache version", 'styles.css?v=4.1' in html or 'styles.css?v=4.2' in html)
            self.assert_test("app.js has fresh cache version", 'app.js?v=4.1' in html or 'app.js?v=4.2' in html)
        else:
            self.assert_test("styles.css has cache version ?v=4.2", 'styles.css?v=4.2' in html)
            self.assert_test("app.js has cache version ?v=4.2", 'app.js?v=4.2' in html)
        ...
        self.assert_test(
            ...
            "travel-scout-v4.2" in sw_res.text or "travel-scout-v4.1" in sw_res.text
        )
